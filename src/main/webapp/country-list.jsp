...
<c:set var="pageUrl" value="/country" scope="page" />
<t:wrapper>
    <main>
        <section class="weather-calendar">
            <h1 class="weather-calendar__title">Country list</h1>
            ...
            <table class="weather__table">
                ...
                <c:forEach var="entity" items="${list}" varStatus="loopCounter">
                    <tr class="table-body__item">
						...
						onclick="sendHTTPDelete('/country?id=${entity.id}')"><i class="material-icons">delete</i></a></td>
                    </tr>
                    </c:forEach>
                </tbody>
            </table>
            <div class="weather-calendar__add-container">
                <a href="/country?view=edit" class="weather-calendar__add">
